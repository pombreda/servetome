...
SRC_PATH="/home/kate/Source/ffmpeg"
SRC_PATH_BARE=/home/kate/Source/ffmpeg
BUILD_ROOT="/home/kate/Source/ffmpeg"
ARCH=x86
CC=gcc
AS=gcc
LD=gcc
...
CFLAGS= --static -march=pentium-m -std=c99 -fomit-frame-pointer -pthread -Wdeclaration-after-statement -Wall -Wno-switch -Wdisabled-optimization -Wpointer-arith -Wredundant-decls -Wno-pointer-sign -Wcast-qual -Wwrite-strings -Wtype-limits -Wundef -Wmissing-prototypes -O3 -fno-math-errno -fno-signed-zeros -fno-tree-vectorize -Werror=implicit -Werror=missing-prototypes
ASFLAGS= --static -march=pentium-m
CC_O=-o $@
...
EXTRALIBS= /usr/lib/libfribidi.a /usr/lib/libass.a /usr/lib/libfontconfig.a /usr/lib/libfreetype.a /usr/lib/libexpat.a /usr/lib/libfaac.a /usr/lib/libfaad.a -static -L/usr/lib /home/kate/Source/libenca.a  -lz -pthread -lm -lfaac -lfaad -lmp3lame -lm -lopencore-amrnb -lm -lopencore-amrwb -lm -ltheoraenc -ltheoradec -logg -lx264 -lm -ldl
INSTALL=install
LIBTARGET=
